...
public class Page {
    ...
    /*private final static String FULLWIDTH = "183mm";
    private final static String FULLHEIGHT = "265mm";
    private final static String HALFWIDTH = "91.5mm";
    private final static String HALFHEIGHT = "132.5mm";*/
