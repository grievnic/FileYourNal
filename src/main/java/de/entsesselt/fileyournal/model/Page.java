...
public class Page {
   ...
   /* *//*Organizer org = new Organizer();*//*
    ...
    //QUAD
        }else if (templateType.equals("quad")){ // if template ist only quarters
    ...
    //HALFQUAD
        }else if (templateType.equals("halfQuad")){ // half top - quarters at bottom
            // <fo:block> incl. page break
            newPage = new Element("block", fo);
            newPage.setAttribute("page-break-before", "always");
    ...
    //QUADHALF
        }else if (templateType.equals("quadHalf")){ // top quarters - bottom half
            // <fo:block> incl. page break
            newPage = new Element("block", fo);
            newPage.setAttribute("page-break-before", "always");
    ...
    //FULL
        }else { // templateType is "full" - fullpage
            // <fo:block> incl. page break
            newPage = new Element("block", fo);
            newPage.setAttribute("page-break-before", "always");
